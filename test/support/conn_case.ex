defmodule UptrackWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use UptrackWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint UptrackWeb.Endpoint

      use UptrackWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import UptrackWeb.ConnCase
    end
  end
