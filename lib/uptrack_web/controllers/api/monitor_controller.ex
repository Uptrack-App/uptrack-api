defmodule UptrackWeb.Api.MonitorController do
  ...
  def create(conn, %{"url" => url} = params) do
    ...
    attrs =
      ...
      |> Map.merge(params |> Map.take(["name", "interval", "timeout", "monitor_type", "confirmation_threshold", "confirmation_window", "regions_required", "reminder_interval_minutes"]) |> atomize_keys())
