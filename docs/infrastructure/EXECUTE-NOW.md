...
# Test eu-b
ssh -o ConnectTimeout=5 root@REMOVED_IP "echo 'eu-b: OK'; hostname"

# Test eu-c
ssh -o ConnectTimeout=5 root@REMOVED_IP "echo 'eu-c: OK'; hostname"
```
...
```bash
# From eu-a, ping eu-b
ssh root@REMOVED_IP 'ping -c 3 100.64.1.2'
# Expected: <20ms latency

# From eu-a, ping eu-c
ssh root@REMOVED_IP 'ping -c 3 100.64.1.3'
# Expected: <20ms latency
```
