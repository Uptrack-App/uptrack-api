...
#   ./benchmark-vps.sh 194.180.207.225 root ~/.ssh/id_ed25519
#   ./benchmark-vps.sh 194.180.207.225 root ~/.ssh/id_ed25519 quick    # Skip Geekbench
#   ./benchmark-vps.sh 194.180.207.225 root ~/.ssh/id_ed25519 full     # Full benchmark
...
if [ -z "$HOST" ]; then
    ...
    echo "  $0 194.180.207.225 root ~/.ssh/id_ed25519 quick"
    echo "  $0 194.180.207.225 root ~/.ssh/id_ed25519 full"
    exit 1
fi
